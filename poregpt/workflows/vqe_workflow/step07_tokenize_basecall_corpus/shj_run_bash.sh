...
MODEL_CKPT="/mnt/zzbnew/rnamodel/zhoukexuan/poregpt/poregpt/workflows/vqe_workflow/step02_train_vqe_model/test-zhoukexuan-model-type25-cnn_type2-teacher_model_distill_1/models/porepgt_vqe_tokenizer.step25000.pth"
