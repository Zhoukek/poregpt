...
torchrun --nproc_per_node=4 --rdzv_endpoint=localhost:29502 \
	...
	--run_name="olmo-pt-bioseq-150m-dna32g-split1280_overlap256-vqe_teacher-4k" \
        ...
        --load_path="" \
        --save_folder="/mnt/zzbnew/rnamodel/shenhaojie/signalDNAmodel/test-haojieshen-model-type26-cnn_type13_teacher_model_distill0.1_VQ_4k_lemon/output_test_ctx1280-lr5e4-vqe_teacher/steps/" 2>&1 | tee run.log
