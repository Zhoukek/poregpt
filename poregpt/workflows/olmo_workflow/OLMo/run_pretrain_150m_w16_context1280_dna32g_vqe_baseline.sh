...
torchrun --nproc_per_node=4 --rdzv_endpoint=localhost:29502 \
	scripts/train.py configs/config_20m_vqed-16k_ctx1280_dna32g_baseline.yaml \
	--run_name="olmo-pt-bioseq-20m-dna32g-split1280_overlap256-vqe_baseline" \
        --wandb.entity="zhoukek-zhejiang-university" \
        --wandb.project="olmo-pt" \
        --load_path="" \
        --save_folder="/mnt/zzbnew/rnamodel/shenhaojie/signalDNAmodel/test-haojieshen-model-type26-cnn_type13_baseline_model_VQ_16k-lemon/output_20m_ctx1280-lr5e4-vqe_baseline_16k/steps/" 2>&1 | tee run.log
