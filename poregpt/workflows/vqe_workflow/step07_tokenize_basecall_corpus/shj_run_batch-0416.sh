...
OUTPUT_DIR="/mnt/zzbnew/rnamodel/shenhaojie/signalDNAmodel/test-kexuanzhou-model-type25-cnn_type13-transfomrmer-teacher_model-distill1-mongo/basecall"
...
for ((i=0; i<total; i++)); do
    ...
    if [ ! -f "$csv_path" ]; then
        ...
        skipped=$((skipped + 1)) # 认为找不到 CSV 的也算跳过
        continue
    fi
